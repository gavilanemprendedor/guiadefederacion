// Categorías (rubros) de la Guía de Federación.
// "nombre" es la clave exacta usada para filtrar en data/negocios.js — no cambiar sin actualizar ahí también.
// "etiqueta" es el texto más corto que se muestra en las tarjetas/títulos.
// "icono" hace referencia a una clave del diccionario ICONOS en js/main.js

const RUBROS = [
  { nombre: "Alojamientos", etiqueta: "Alojamientos", icono: "home" },
  { nombre: "Bienestar", etiqueta: "Bienestar", icono: "heart" },
  { nombre: "Comidas para llevar", etiqueta: "Comidas para llevar", icono: "utensils" },
  { nombre: "Despensas", etiqueta: "Despensas", icono: "basket" },
  { nombre: "Seguros", etiqueta: "Seguros", icono: "shield" },
  { nombre: "Eventos-Fiestas", etiqueta: "Eventos y fiestas", icono: "party" },
  { nombre: "Bailables", etiqueta: "Bailables", icono: "music" },
  { nombre: "Tiendas", etiqueta: "Tiendas", icono: "bag" },
  { nombre: "Quinielas", etiqueta: "Quinielas", icono: "ticket" },
  { nombre: "Gimnasios", etiqueta: "Gimnasios", icono: "dumbbell" },
  { nombre: "Librerías/Jugueterías", etiqueta: "Librerías y jugueterías", icono: "book" },
